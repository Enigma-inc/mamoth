...
<html lang="en">
  ...
  <head>
<meta charset="utf-8"/>
    <title>Mamothe Funeral Home</title>
...
<section class="c-layout-revo-slider c-layout-revo-slider-13 margin-0 " dir="ltr">
  ...
  @include('social-media')
        <footer class="c-layout-footer c-layout-footer-6 c-bg-grey-1 padding-top-0">
            <div class="c-postfooter c-bg-purple">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 col-sm-12 c-col">
                            <p class="c-copyright c-font-grey">2017 &copy; MAMOTHE
